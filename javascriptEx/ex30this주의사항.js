...
console.log(printName.call(cat)); // 원래 최상이 객체의 주소값인데 => this를 cat의 주소값으로 변경후 실행

console.log(printName.apply({ name: "김진수" }));
...
console.log(printName.bind(dog)); // bound 는 bind 의 과거형
